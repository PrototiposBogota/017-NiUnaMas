class VictimsController < ApplicationController
  ...
  private
    ...
    def victim_params
      params.require(:victim).permit(:name, :surname, :email, :password, :phone_number, :document_type, :document_number, :attendant_name, :attendant_phone_number, :sexual_orientation, :district, :picture)
    end
end
