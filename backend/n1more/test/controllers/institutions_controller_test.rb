...
class InstitutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post institutions_url, params: { institution: { attention_center_id: @institution.attention_center_id, institution_type: @institution.institution_type } }
    end
  ...
  test "should update institution" do
    patch institution_url(@institution), params: { institution: { attention_center_id: @institution.attention_center_id, institution_type: @institution.institution_type } }
