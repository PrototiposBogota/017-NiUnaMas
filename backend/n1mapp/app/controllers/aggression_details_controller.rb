class AggressionDetailsController < ApplicationController
  ...
  private
    ...
    def aggression_detail_params
      params.require(:aggression_detail).permit(:user_id, :perpetrator_name, :perpetrator_age, :perpetrator_gender, :relatioship, :live_together, :aggression_date, :aggression_time, :mechanism, :scene, :proof_file, :latitude_report, :longitude_report)
    end
end
